...
class ContentQuizData {
  ...
  factory ContentQuizData.fromJson(Map<String, dynamic> json) {
    return ContentQuizData(
      skillDrills: (json['skillDrills'] as List<dynamic>?)
          ?.map((drill) => SkillDrill.fromJson(drill))
          .toList() ?? [],
      softSkillScenarios: (json['softSkillScenarios'] as List<dynamic>?)
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'softSkillScenarios': softSkillScenarios.map((scenario) => scenario.toJson()).toList(),
