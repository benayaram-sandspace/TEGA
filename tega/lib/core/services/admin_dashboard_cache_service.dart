...
class AdminDashboardCacheService {
  ...
  Future<Map<String, dynamic>?> getStudentsDataByCollege(String collegeName) async {
    await _ensureDatabase();
    try {
      final results = await _database!.query(
        _tableName,
  ...
  Future<void> setStudentsDataByCollege(String collegeName, Map<String, dynamic> data) async {
    await _ensureDatabase();
    try {
      final dataJson = json.encode(data);
      await _database!.insert(
  ...
  Future<void> setNotificationsData(List<Map<String, dynamic>> notifications) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<List<Map<String, dynamic>>?> getExamsData() async {
    ...
    try {
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['exams'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<List<Map<String, dynamic>>?> getQuestionPapersData() async {
    ...
    try {
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['questionPapers'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<void> setQuestionPapersData(List<Map<String, dynamic>> questionPapers) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<List<Map<String, dynamic>>?> getExamRegistrationsData(String examId) async {
    await _ensureDatabase();
    try {
      final results = await _database!.query(
        _tableName,
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['registrations'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<void> setExamRegistrationsData(String examId, List<Map<String, dynamic>> registrations) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<List<Map<String, dynamic>>?> getExamResultsData(String examId) async {
    ...
    try {
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['results'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<void> setExamResultsData(String examId, List<Map<String, dynamic>> results) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<Map<String, dynamic>?> getJobsData({
    ...
    try {
      ...
      final cacheKey = 'jobs_data_${searchQuery ?? ''}_${status ?? 'all'}_${type ?? 'all'}_$page';
  ...
  Future<List<Map<String, dynamic>>?> getPlacementPrepQuestionsData() async {
    ...
    try {
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['questions'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<void> setPlacementPrepQuestionsData(List<Map<String, dynamic>> questions) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<List<Map<String, dynamic>>?> getPlacementPrepModulesData() async {
    ...
    try {
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['modules'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<void> setPlacementPrepModulesData(List<Map<String, dynamic>> modules) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<void> setCompanyQuestionsData(List<Map<String, dynamic>> questions) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
  ...
  Future<List<Map<String, dynamic>>?> getCompanyListWithDetailsData() async {
    ...
    try {
      ...
      final data = json.decode(dataJson) as Map<String, dynamic>;
      if (data['success'] == true) {
        return List<Map<String, dynamic>>.from(data['companies'] ?? data['data'] ?? []);
      }
      return null;
    } catch (e) {
      return null;
  ...
  Future<void> setCompanyListWithDetailsData(List<Map<String, dynamic>> companies) async {
    await _ensureDatabase();
    try {
      final data = {
        'success': true,
