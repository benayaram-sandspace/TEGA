...
class _ModulesTabState extends State<ModulesTab> {
  ...
  Widget _buildModulesGrid(bool isMobile, bool isTablet, bool isDesktop) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final runSpacing = isMobile ? 8.0 : isTablet ? 10.0 : 12.0;
        ...
        return GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: isMobile ? 2.0 : isTablet ? 2.05 : 2.1,
          ),
          itemCount: _modules.length,
          itemBuilder: (context, index) {
            return _buildModuleCard(_modules[index], isMobile, isTablet, isDesktop);
          },
        );
      },
    );
  ...
  Widget _buildModuleCard(Map<String, dynamic> module, bool isMobile, bool isTablet, bool isDesktop) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: isMobile ? 5 : isTablet ? 5.5 : 6),
          // Title
          Text(
            title,
            style: TextStyle(
          ...
          Row(
            children: [
              ...
              SizedBox(width: isMobile ? 4 : isTablet ? 4.5 : 5),
              Text(
                moduleType,
                style: TextStyle(
                  fontSize: isMobile ? 11 : isTablet ? 11.5 : 12,
  ...
  Widget _buildActionButton({
    ...
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(isMobile ? 5 : isTablet ? 5.5 : 6),
      child: Container(
