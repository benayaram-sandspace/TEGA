...
class EditCoursePageNew extends StatefulWidget {
  final Map<String, dynamic> course;

  const EditCoursePageNew({super.key, required this.course});

  @override
  State<EditCoursePageNew> createState() => _EditCoursePageNewState();
}

class _EditCoursePageNewState extends State<EditCoursePageNew> {
        ...
        Container(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              hintText: hintText,
              prefixIcon: Icon(icon, color: AdminDashboardStyles.primary),
