...
class _EditCoursePageState extends State<EditCoursePage> {
  ...
  void _initializeControllers() {
    ...
    _shortDescriptionController = TextEditingController(
      text: widget.course['shortDescription'] ?? widget.course['description'] ?? '',
    );
    _fullDescriptionController = TextEditingController(
      text: widget.course['fullDescription'] ?? widget.course['description'] ?? '',
    );
  ...
  Future<void> _updateCourse() async {
    ...
    try {
      ...
      final result = await _dashboardService.updateCourse(
        widget.course['_id'],
        courseData,
      );
      ...
      if (result['success'] == true) {
        ...
        throw Exception(result['message'] ?? 'Failed to update course');
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
