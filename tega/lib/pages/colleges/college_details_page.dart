...
import 'college_analytics_page.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildStatItem('Total Admins', widget.college.admins.length.toString()),
                    _buildStatItem('Total Students', widget.college.students.length.toString()),
                  ],
                ),
                const SizedBox(height: 12),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _buildStatItem('Active Admins', 
                        widget.college.admins.where((admin) => admin.status == 'Active').length.toString()),
                    _buildStatItem('Avg. Score', '${widget.college.avgSkillScore.toInt()}%'),
                  ],
                ),
              ],
            ),
