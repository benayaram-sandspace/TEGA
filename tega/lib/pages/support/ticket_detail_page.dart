...
class _TicketDetailPageState extends State<TicketDetailPage>
  ...
  Widget _buildConversationTab() {
    final conversationMessages = _ticket!.messages.where((msg) => !msg.isInternal).toList();
  ...
  Widget _buildInternalNotesTab() {
    final internalMessages = _ticket!.messages.where((msg) => msg.isInternal).toList();
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 14,
                      color: isSupport ? AppColors.textPrimary : AppColors.pureWhite,
                    ),
                  ),
                ),
                const SizedBox(height: 4),
