...
class ConfigureCollegeReportPage extends StatefulWidget {
  const ConfigureCollegeReportPage({Key? key}) : super(key: key);

  @override
  State<ConfigureCollegeReportPage> createState() =>
      _ConfigureCollegeReportPageState();
}

class _ConfigureCollegeReportPageState
    extends State<ConfigureCollegeReportPage> {
  ...
  void _downloadReport() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Downloading $_selectedExportFormat report for $_selectedCollege...',
        ),
