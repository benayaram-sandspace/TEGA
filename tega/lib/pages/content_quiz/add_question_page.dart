...
class _AddQuestionPageState extends State<AddQuestionPage> {
  ...
  final List<String> _questionTypes = ['Multiple Choice', 'True/False', 'Fill in the Blank'];
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<int>(
                    ...
                    icon: const Icon(Icons.keyboard_arrow_up, color: AppColors.pureWhite),
                    items: [
                      DropdownMenuItem(
                        value: 0,
                        child: Text('Option 1${_option1Controller.text.isNotEmpty ? ': ${_option1Controller.text}' : ''}'),
                      ),
                      DropdownMenuItem(
                        value: 1,
                        child: Text('Option 2${_option2Controller.text.isNotEmpty ? ': ${_option2Controller.text}' : ''}'),
                      ),
                      DropdownMenuItem(
                        value: 2,
                        child: Text('Option 3${_option3Controller.text.isNotEmpty ? ': ${_option3Controller.text}' : ''}'),
                      ),
                      DropdownMenuItem(
                        value: 3,
                        child: Text('Option 4${_option4Controller.text.isNotEmpty ? ': ${_option4Controller.text}' : ''}'),
                      ),
                    ],
                    onChanged: (value) {
                      setState(() {
