...
class _FlaggedUsersPageState extends State<FlaggedUsersPage> {
  ...
  void _loadFlaggedUsers() {
    _flaggedUsers = [
      ...
      FlaggedUser('Anika Verma', 'College of Arts and Sciences', 'Pending Review'),
      FlaggedUser('Rohan Kapoor', 'School of Business', 'Pending Review'),
      FlaggedUser('Ishaan Singh', 'College of Engineering', 'Pending Review'),
      FlaggedUser('Diya Patel', 'College of Arts and Sciences', 'Pending Review'),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFilterDropdown(
              'Filter by Flag Reason',
              _selectedFlagReason,
              ['All', 'Inappropriate Content', 'Suspicious Activity', 'Policy Violation', 'Academic Misconduct'],
              (value) {
                setState(() {
            ...
            _buildFilterDropdown(
              'Filter by College',
              _selectedCollege,
              ['All', 'College of Engineering', 'College of Arts and Sciences', 'School of Business'],
              (value) {
                setState(() {
            ...
            _buildFilterDropdown(
              'Date Range',
              _selectedDateRange,
              ['Select Date Range', 'Last 7 days', 'Last 30 days', 'Last 3 months', 'Custom Range'],
              (value) {
                setState(() {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => StudentProfilePage(
                    student: Student.basic(user.name, user.college, user.status),
                  ),
                ),
              );
            },
